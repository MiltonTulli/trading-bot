    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <input type="date" value={params.startDate} onChange={e => set('startDate', e.target.value)}
            className="input text-xs" min="2021-01-01" max="2026-02-28" />
          <input type="date" value={params.endDate} onChange={e => set('endDate', e.target.value)}
            className="input text-xs" min="2021-01-01" max="2026-02-28" />
        </div>
      </div>
